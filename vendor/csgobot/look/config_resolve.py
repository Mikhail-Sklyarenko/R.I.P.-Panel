"""Environment overrides for patrol look (PR-L1…L1.3)."""
...
def resolve_look_config(default: LookConfig) -> LookConfig:
    ...
    hard_max = _env_float("CSGOBOT_LOOK_SWEEP_HARD_MAX")
    ...
    mouse_hz = _env_float("CSGOBOT_LOOK_MOUSE_HZ")
    return LookConfig(
        ...
        sweep_sec_hard_max=(
            hard_max if hard_max is not None else default.sweep_sec_hard_max
        ),
        ...
        mouse_hz=mouse_hz if mouse_hz is not None else default.mouse_hz,
    )
